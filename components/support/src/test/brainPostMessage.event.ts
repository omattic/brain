export const event = {
  "event": {
    ...
    "_from": "brain",
    "params": {
      "text": "Los precios varían según el curso y las opciones que elijas. Te invito a que visites mi página en https://curso.inglesconliza.com/ ahí encontrarás toda la información sobre los precios y cómo suscribirte en solo unos pocos clics. Si tienes alguna otra pregunta, ¡no dudes en preguntarme! :blush::two_hearts:"
    }
  },
  "context": {
    "event": {
      ...
      "root": {
        ...
        "reply_count": 18,
        "reply_users_count": 2,
        "latest_reply": "1745956005.475849",
        "reply_users": [
          "B081AM1MACX",
          "U081JJPQDT8"
        ],
      ...
      "username": "Carlos (+34653596182)",
      "type": "message",
      "ts": "1745956005.475849",
      "app_id": "A081TNA8XPW",
      "text": "And how much does it cost?",
      "blocks": [
        {
          "type": "rich_text",
          "block_id": "XlB",
    ...
    "state": {
      ...
      "eventTs": "1745956005.475849",
      "isIm": false,
      "isGroup": false,
      "messageUsername": "carlos (+34653596182)",
      "incomingMessageText": "And how much does it cost?",
      "hasBotProfile": false,
      "channelContext": {
        "config": {
          "disableBot": false,
